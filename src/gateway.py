...
class Gateway:
  ...
  #   self.gatewayLogger.info(positions)
  #   for pos in positions:
  #     pos['instrument'] = "SPC." + pos['instrument']
  #   return positions

  # def getTrades(self, n, includeOld=True, instrument="all"):
  #   options = {
  #       "instrument": instrument,
  #       "count": n,
  #       "includeOld":"true" if includeOld else "false"
  #   }
        
  #   return self.client.request("/api/v1/private/tradehistory", options)

  # def getExpirationTrades(self, n, instrument="all"):
  #   options = {
  #       "instrument": instrument,
  #       "count": n,
  #       "type": "delivery"
  ...
  #   return self.client.request("/api/v1/private/settlementhistory", options)['settlements']
  
  # def getFunding(self, n, instrument="BTC-PERPETUAL"):
  #   options = {
  #       "instrument": instrument,
  #       "count": n,
  #       "type": "settlement"
  ...
  # def submitOrder(self, side, instrument, quantity, price, timeInForce="good_til_cancelled", postOnly=False, maxShow=-1):
  #   self.messageNumber += 1
  #   data = {
  #           "id": self.messageNumber, 
  #           "action": "/api/v1/private/" + side,  
  #           "arguments": {
  #               "instrument": str(instrument.split(".")[1]),
  #               "quantity": self.zpad(str(quantity), 1),
  #               "price": self.zpad(str(price), 1),
  #               "time_in_force": timeInForce,
  #           }
  #       }
  #   if postOnly:
  #     data['arguments']['post_only'] = "true"
  #   if maxShow >= 0:
  #     data['arguments']['max_show'] = str(maxShow)
  #   data['sig'] = self.client.generate_signature(data['action'], data['arguments'])

  #   self.q.put(data)
  #   self.gatewayLogger.info(data)
  #   return self.messageNumber

  # def editOrder(self, orderId, quantity, price, instrument):
  #   self.messageNumber += 1
  #   data = {
  #           "id": self.messageNumber, 
  ...
  # def cancelAll(self, cancelType="all"):
  #   if self.status:
  #     self.messageNumber += 1
  #     data = {
  #             "id": self.messageNumber, 
  ...
  #     return self.messageNumber
  #   else:
  #     #websocket is disconnected send via REST
  #     self.client.cancelall(cancelType)
  ...
  # def getResponse(self, messageId, timeout=.5):
  #   timeout = time.time() + timeout
  #   while True:
  #     if messageId in self.response:
  #       self.gatewayLogger.info(self.response[messageId])
